...
if choicer.lower() == "unpack":
    ...
    if os.path.isfile(pathToFile) == True: # checks that the file exists
        ...
        DDSheaderBytes = b'DDS |\x00\x00\x00\x07\x10\n\x00@\x00\x00\x00@\x00\x00\x00\x00\x08\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x04\x00\x00\x00DXT1\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
...
if choicer.lower() == "repack":
    ...
    # check magic number + extension
        ...
        if struct.unpack_from("I", rawNewData, 84)[0] != 827611204:
            print("Wrong DDS format.\nTry using BC1/DXT1, and don't generate mipmaps.")
            input("Press enter to exit.")
            quit()
            
        # get rid of dds header
        rawNewData = rawNewData[128:]
